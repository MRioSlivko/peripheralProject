...
int main(int argc, char *argv[])
{
    ...
    engine.rootContext()->setContextProperty("page4Text", readAndDisplayText("/home/misha/dmesg.txt"));
    engine.rootContext()->setContextProperty("page5Text", readAndDisplayText("/home/misha/portinfo.txt"));
    engine.rootContext()->setContextProperty("page6Text", readAndDisplayText("/home/misha/4laba.txt"));
